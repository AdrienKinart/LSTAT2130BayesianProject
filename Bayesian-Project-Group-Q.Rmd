...
plot(density(diff_of_mu), main = "Credibles intervals for the difference of Net Income between Flanders and Wallonia", xlab = 'mu_1 - mu_2')
legend("topleft", legend = c("Quantile-based intervals", "HPD intervals"), col = 1:2 , lty=1:2)
abline(v=quantile(diff_of_mu, probs=c(0.025,0.975), col= 'red' , lty=2))
abline(v= HPDinterval(as.mcmc(diff_of_mu)), col=2, lty=2)
```
